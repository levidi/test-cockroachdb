...
class MessageServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendMessages = channel.stream_unary(
                '/example.MessageService/SendMessages',
        ...
        self.GetMessage = channel.unary_unary(
                '/example.MessageService/GetMessage',
                request_serializer=message__pb2.MessageFilter.SerializeToString,
                response_deserializer=message__pb2.Message.FromString,
                _registered_method=True)
...
def add_MessageServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetMessage': grpc.unary_unary_rpc_method_handler(
                    servicer.GetMessage,
                    request_deserializer=message__pb2.MessageFilter.FromString,
                    response_serializer=message__pb2.Message.SerializeToString,
            ),
    }
    ...
    server.add_registered_method_handlers('example.MessageService', rpc_method_handlers)
...
class MessageService(object):
    ...
    def GetMessage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/example.MessageService/GetMessage',
            message__pb2.MessageFilter.SerializeToString,
            message__pb2.Message.FromString,
            options,
            channel_credentials,
            insecure,
